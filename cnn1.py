...
layer_cnn0 = tf.layers.Conv2D(280, 2, activation=tf.nn.relu)
layer_pool1x1 = tf.layers.MaxPooling2D(1, 1)
layer_pool2x2 = tf.layers.MaxPooling2D(2, 2)
layer_pool3x3 = tf.layers.MaxPooling2D(3, 3)
layer_pool4x4 = tf.layers.MaxPooling2D(4, 4)
layer_cnn1 = tf.layers.Conv2D(64, 2, activation=tf.nn.relu)
layer_cnn2= tf.layers.Conv2D(560, 2, activation= tf.nn.relu)
